...
namespace Wist.Blockchain.Core.Parsers.Transactional
{
	...
	public class TransferAssetToUtxoParser : TransactionalTransitionalPacketParserBase
	{
		public TransferAssetToUtxoParser(IIdentityKeyProvidersRegistry identityKeyProvidersRegistry) :
