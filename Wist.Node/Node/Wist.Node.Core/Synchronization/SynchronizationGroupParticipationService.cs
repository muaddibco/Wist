    ...
    public class SynchronizationGroupParticipationService : ISynchronizationGroupParticipationService
    {
        ...
        private string SynchronizationGroupParticipationCheckAction(string arg)
        {
            ...
            try
            {
                ...
                _isParticipating = _nodesRatingProvider.IsCandidateInTopList(_nodeContext.AccountKey);
            ...
            lock (_sync)
            {
                ...
                try
                {
                    ...
                    if (recheckPosition)
                    {
                        ...
                        _roundStarted = true;
                        _ratingPosition = _nodesRatingProvider.GetCandidateRating(_nodeContext.AccountKey) + 1;
